...
} from "./chunk-V7GAMKUI.js";
import "./chunk-JEELEIFD.js";
import {
  DataTile_default,
  ERROR_THRESHOLD,
  ...
  translation,
  withinExtentAndZ
} from "./chunk-BRHADW6T.js";
import {
  TileQueue_default,
  VectorRenderTile_default,
  VectorTile_default
} from "./chunk-37FK5NUI.js";
import {
  DEFAULT_MAX_ZOOM,
  DEFAULT_TILE_SIZE,
  Feature_default,
...
var require_find_tag_by_name = __commonJS({
  "node_modules/xml-utils/find-tag-by-name.js"(exports, module) {
    ...
    function findTagByName(xml, tagName, options) {
      ...
      const start = indexOfMatch(xml, "<".concat(tagName, "[ \n>/]"), startIndex);
    ...
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          console.warn('Module "http" has been externalized for browser compatibility. Cannot access "http.'.concat(key, '" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.'));
        }
      }
    }));
  }
...
var require_https = __commonJS({
  "browser-external:https"(exports, module) {
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          console.warn('Module "https" has been externalized for browser compatibility. Cannot access "https.'.concat(key, '" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.'));
        }
      }
    }));
  }
...
var require_url = __commonJS({
  "browser-external:url"(exports, module) {
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          console.warn('Module "url" has been externalized for browser compatibility. Cannot access "url.'.concat(key, '" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.'));
        }
      }
    }));
  }
...
var require_fs = __commonJS({
  "browser-external:fs"(exports, module) {
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          console.warn('Module "fs" has been externalized for browser compatibility. Cannot access "fs.'.concat(key, '" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.'));
        }
      }
    }));
  }
...
addDecoder([void 0, 1], () => import("./raw-RXYTW47X.js").then((m) => m.default));
addDecoder(5, () => import("./lzw-JLJJC4RU.js").then((m) => m.default));
addDecoder(6, () => {
  throw new Error("old style JPEG compression is not supported.");
});
addDecoder(7, () => import("./jpeg-AHSL5DFC.js").then((m) => m.default));
addDecoder([8, 32946], () => import("./deflate-QCZ7ZE5U.js").then((m) => m.default));
addDecoder(32773, () => import("./packbits-4FR3PNQJ.js").then((m) => m.default));
addDecoder(34887, () => import("./lerc-2SPGLXAK.js").then((m) => __async(void 0, null, function* () {
  yield m.zstd.init();
  return m;
})).then((m) => m.default));
addDecoder(50001, () => import("./webimage-ZXBJJF64.js").then((m) => m.default));
      ...
      if (!samples || !samples.length) {
        ...
        for (let i = 0; i < samples.length; ++i) {
          if (samples[i] >= samplesPerPixel) {
            return Promise.reject(new RangeError("Invalid sample index '".concat(samples[i], "'.")));
          }
        }
      }
      let valueArrays;
  ...
  constructor(size = defaultPoolSize, createWorker2) {
    ...
    if (size) {
      this._awaitingDecoder = createWorker2 ? Promise.resolve(createWorker2) : new Promise((resolve) => {
        import("./decoder-AHIYGFGQ.js").then((module) => {
    ...
    return __async(this, null, function* () {
      const response = yield this.client.request({
        headers: __spreadProps(__spreadValues({}, this.headers), {
          Range: "bytes=".concat(slices.map(({
            offset,
            length
          }) => "".concat(offset, "-").concat(offset + length)).join(","))
        }),
        signal
      });
      if (!response.ok) {
...
var GeoTIFFImageIndexError = class extends Error {
  constructor(index) {
    super("No image at index ".concat(index));
    this.index = index;
  }
};
  ...
  configure_(sources) {
    ...
    for (let sourceIndex = 0; sourceIndex < sourceCount; ++sourceIndex) {
      ...
      if (!origin) {
        ...
        const message = "Origin mismatch for source ".concat(sourceIndex, ", got [").concat(sourceOrigin, "] but expected [").concat(origin, "]");
      ...
      if (!resolutions) {
        ...
        const message = "Resolution mismatch for source ".concat(sourceIndex, ", got [").concat(scaledSourceResolutions, "] but expected [").concat(resolutions, "]");
      ...
      if (!commonRenderTileSizes) {
        ...
        assertEqual(commonRenderTileSizes.slice(minZoom, commonRenderTileSizes.length), renderTileSizes, 0.01, "Tile size mismatch for source ".concat(sourceIndex), this.viewRejector);
      }
      if (!commonSourceTileSizes) {
        commonSourceTileSizes = sourceTileSizes;
      } else {
        assertEqual(commonSourceTileSizes.slice(minZoom, commonSourceTileSizes.length), sourceTileSizes, 0, "Tile size mismatch for source ".concat(sourceIndex), this.viewRejector);
      }
...
var Google = class extends TileImage_default {
  ...
  createSession_() {
    return __async(this, null, function* () {
      ...
      this.tileUrlFunction = function(tileCoord, pixelRatio, projection) {
        ...
        const x = tileCoord[1];
        const y = tileCoord[2];
        const url2 = "".concat(tileUrl, "/").concat(z, "/").concat(x, "/").concat(y, "?session=").concat(session, "&key=").concat(key);
        return url2;
      };
  ...
  fetchAttributions_(frameState) {
    return __async(this, null, function* () {
      ...
      const viewportExtent = "zoom=".concat(zoom, "&north=").concat(north, "&south=").concat(south, "&east=").concat(east, "&west=").concat(west);
      ...
      const key = this.apiKey_;
      const url = "".concat(attributionUrl, "?session=").concat(session, "&key=").concat(key, "&").concat(viewportExtent);
...
function createLoader(options) {
  ...
  const ratio = (_a = options.ratio) != null ? _a : 1.5;
  const crossOrigin = (_b = options.crossOrigin) != null ? _b : null;
...
function createLoader2(options) {
  ...
  const useOverlay = (_a = options.useOverlay) != null ? _a : false;
  const metersPerUnit = options.metersPerUnit || 1;
  const displayDpi = options.displayDpi || 96;
  const ratio = (_b = options.ratio) != null ? _b : 1;
  const crossOrigin = (_c = options.crossOrigin) != null ? _c : null;
  return function(extent, resolution, pixelRatio) {
    const image = new Image();
    image.crossOrigin = crossOrigin;
    extent = getRequestExtent(extent, resolution, pixelRatio, ratio);
...
function createLoader3(options) {
  ...
  const crossOrigin = (_a = options.crossOrigin) != null ? _a : null;
  return () => {
    const image = new Image();
    image.crossOrigin = crossOrigin;
...
function loadImage(template, z, x, y, options) {
  return new Promise((resolve, reject) => {
    var _a;
    const image = new Image();
    image.crossOrigin = (_a = options.crossOrigin) != null ? _a : null;
...
function parseTileMatrixSet(sourceInfo, tileMatrixSet, tileUrlTemplate, tileMatrixSetLimits) {
  ...
  if (!projection) {
    ...
    if (!projection) {
      throw new Error("Unsupported CRS: ".concat(JSON.stringify(tileMatrixSet.crs)));
    }
  }
