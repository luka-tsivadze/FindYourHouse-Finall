...
function intersectsLineString(flatCoordinates, offset2, end, stride, extent, coordinatesExtent) {
  coordinatesExtent = coordinatesExtent != null ? coordinatesExtent : extendFlatCoordinates(createEmpty(), flatCoordinates, offset2, end, stride);
...
var LineString = class _LineString extends SimpleGeometry_default {
  ...
  getFlatMidpoint() {
    ...
    if (this.flatMidpointRevision_ != this.getRevision()) {
      this.flatMidpoint_ = this.getCoordinateAt(0.5, (_a = this.flatMidpoint_) != null ? _a : void 0);
...
//# sourceMappingURL=chunk-JV5OAI3L.js.map
