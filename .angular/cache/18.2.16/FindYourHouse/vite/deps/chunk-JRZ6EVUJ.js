...
function provideHttpClient(...features) {
  ...
  const providers = [HttpClient, HttpXhrBackend, HttpInterceptorHandler, {
    ...
    useFactory: () => {
      var _a;
      return (_a = inject(FetchBackend, {
        optional: true
      })) != null ? _a : inject(HttpXhrBackend);
    }
  }, {
...
function verifyMappedOrigin(url) {
  if (new URL(url, "resolve://").pathname !== "/") {
    throw new RuntimeError(2804, "Angular detected a URL with a path segment in the value provided for the " + "`HTTP_TRANSFER_CACHE_ORIGIN_MAP` token: ".concat(url, ". The map should only contain origins ") + "without any other segments.");
  }
}
...
@angular/common/fesm2022/http.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-JRZ6EVUJ.js.map
