...
function drawTextOnPath(flatCoordinates, offset, end, stride, text, startM, maxAngle, scale2, measureAndCacheTextWidth2, font, cache, rotation, keepUpright = true) {
      ...
      switch (type) {
        ...
        case Instruction_default.DRAW_IMAGE:
          ...
          for (; d < dd; d += 2) {
            ...
            const dimensions = this.calculateImageOrLabelDimensions_(image.width, image.height, pixelCoordinates[d], pixelCoordinates[d + 1], width, height, anchorX, anchorY, originX, originY, rotation, scale2, snapToPixel, padding, !!backgroundFillInstruction || !!backgroundStrokeInstruction, feature);
...
var CanvasVectorLayerRenderer = class extends Layer_default {
  ...
  forEachFeatureAtCoordinate(coordinate, frameState, hitTolerance, callback, matches) {
    ...
    const declutter = this.getLayer().getDeclutter();
    return this.replayGroup_.forEachFeatureAtCoordinate(coordinate, resolution, rotation, hitTolerance, featureCallback, declutter ? (_b = (_a = frameState.declutter) == null ? void 0 : _a[declutter]) == null ? void 0 : _b.all().map((item) => item.value) : null);
  }
  /**
...
//# sourceMappingURL=chunk-OYC72OSP.js.map
