...
var ApplyRedirects = class {
  ...
  lineralizeSegments(route, urlTree) {
    ...
    while (true) {
      ...
      if (c.numberOfChildren > 1 || !c.children[PRIMARY_OUTLET]) {
        return namedOutletsRedirect("".concat(route.redirectTo));
      }
  ...
  findPosParam(redirectTo, redirectToUrlSegment, posParams) {
    ...
    if (!pos) throw new RuntimeError(4001, (typeof ngDevMode === "undefined" || ngDevMode) && "Cannot redirect to '".concat(redirectTo, "'. Cannot find '").concat(redirectToUrlSegment.path, "'."));
    return pos;
  }
        ...
        return of(overallTransitionState).pipe(
          switchMap((t) => {
            ...
            if (this.navigationId > overallTransitionState.id) {
              const cancellationReason = typeof ngDevMode === "undefined" || ngDevMode ? "Navigation ID ".concat(overallTransitionState.id, " is not equal to the current navigation id ").concat(this.navigationId) : "";
