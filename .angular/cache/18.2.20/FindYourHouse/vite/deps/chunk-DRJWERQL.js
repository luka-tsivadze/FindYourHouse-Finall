...
var RenderFeature = class _RenderFeature {
  ...
  clone() {
    var _a;
    return new _RenderFeature(this.type_, this.flatCoordinates_.slice(), (_a = this.ends_) == null ? void 0 : _a.slice(), this.stride_, Object.assign({}, this.properties_), this.id_);
  }
  /**
...
var CanvasLayerRenderer = class extends Layer_default2 {
  ...
  useContainer(target, transform, backgroundColor) {
    ...
    if (target && target.className === layerClassName && (!backgroundColor || target && target.style.backgroundColor && equals2(asArray(target.style.backgroundColor), asArray(backgroundColor)))) {
