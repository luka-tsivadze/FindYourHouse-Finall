...
//               id: item.idi,
//               UserId: item.amtvirtvelis_idi,
//               price: this.curService.changeCurrency( currency, Number((item.fasi || '').toString().replace(/[^\d]/g, '')) || 0 ) ,
//               currency:currency,
//               header: item.satauri,
